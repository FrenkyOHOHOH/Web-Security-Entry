...
create database fl44444g default character set utf8 collate utf8_general_ci;

use fl44444g;


CREATE TABLE IF NOT EXISTS `fl4a4ag` (
  `id` int(100) NOT NULL,
  `flag` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

INSERT INTO `fl4a4ag`(`id`, `flag`) VALUES
(11,'1145141919810'),
(45,'flag{example}'),
(14,'https://www.bilibili.com/video/BV1uT4y1P7CX');
...
(17, '2018.09.13', '07:02','flag{this_is_fake_flag}');
